...
export function FirmModal({
  ...
  const handleChange = (
    ...
    setForm((prev) => ({
      ...prev,
      [name]: name === "rating" || name === "minDeposit" || name === "profitSplit"
        ? Number(value)
        : value,
    }));
  };
        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto space-y-4">
          {mode === "edit" ? (
            ...
            <>
              ...
              {firm.description && (
                <p className="text-gray-300 whitespace-pre-line">{firm.description}</p>
              )}
              ...
              {firm.discountCode && (
                <div className="bg-slate-700 border border-cyan-500/30 rounded-lg p-4">
